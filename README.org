...
** KNOWCAUSE the algorithm is returning always True.
...
** TODO Put the function to convert between NBAs and GNBAs in the AutomataTheoreticApproach module [2/2]
...
** The ~dotProduct~ function is actually less efficient when independent from the DTS module.  
