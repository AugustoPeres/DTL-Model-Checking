...
**** TODO It doesn't make sense anymore passing all propositional symbols to the automaton. 
     In fact we should not need to pass any propositional symbols as all
     propositional symbols that the automatons needs are present in the closure
     of the formula.
